# April 1 Test Dataset

## Time Slots (22 slots, 00:34 → 11:16)

### Slot 00:34 → 01:08
**Results:**
- ATM 1:1 OSA (2 - exactly 2)
- BIL 0:0 RSO (0 - UNDER)
- CEL 6:2 OVI (8 - OVER)
- ELC 1:1 SEV (2 - exactly 2)
- GET 1:1 ALA (2 - exactly 2)
- GIR 4:2 VIL (6 - OVER)
- RAY 3:0 FCB (3 - OVER)
- RBB 0:3 LEV (3 - OVER)
- RMA 1:1 MAL (2 - exactly 2)
- VCF 0:0 ESP (0 - UNDER)

**OVER:** 4 | **UNDER:** 2 | **PUSH:** 4
...
**Results:**
- ALA 2:1 VIL (3 - OVER)
- ATM 1:1 SEV (2 - exactly 2)
- CEL 2:0 LEV (2 - OVER)
- ESP 1:0 ELC (1 - UNDER)
- OSA 2:2 VCF (4 - OVER)
- OVI 1:1 GET (2 - exactly 2)
- RAY 2:2 FCB (4 - OVER)
- RBB 0:3 BIL (3 - OVER)
- RMA 5:0 MAL (5 - OVER)
- RSO 3:1 GIR (4 - OVER)
...
**Results:**
- ALA 0:0 GIR (0 - UNDER)
- ATM 1:1 VCF (2 - exactly 2)
- ESP 1:0 CEL (1 - UNDER)
- OSA 1:1 LEV (2 - exactly 2)
- OVI 0:2 FCB (2 - OVER)
- RBB 1:0 MAL (1 - UNDER)
- RMA 0:1 RAY (1 - UNDER)
- RSO 1:0 ELC (1 - UNDER)
...
**Results:**
- ALA 2:2 ELC (4 - OVER)
- ATM 1:1 ESP (2 - exactly 2)
- BIL 1:1 LEV (2 - exactly 2)
- GET 1:1 FCB (2 - exactly 2)
- GIR 2:0 CEL (2 - OVER)
- RBB 2:1 OVI (3 - OVER)
- RSO 1:0 OSA (1 - UNDER)
- SEV 2:1 RAY (3 - OVER)
...
### Slot 06:50 → 07:28
**Results:**
- ALA 1:1 MAL (2 - exactly 2)
- ATM 1:0 OVI (1 - UNDER)
- BIL 1:1 RAY (2 - exactly 2)
- ELC 0:2 FCB (2 - OVER)
- GET 1:3 CEL (4 - OVER)
- GIR 1:2 RMA (3 - OVER)
- RSO 0:1 RBB (1 - UNDER)
...
- GET 0:2 RMA (2 - OVER)
- GIR 2:1 OSA (3 - OVER)
- MAL 1:1 LEV (2 - exactly 2)
- SEV 0:3 OVI (3 - OVER)
- VCF 1:1 RAY (2 - exactly 2)
- VIL 1:6 RBB (7 - OVER)
...
**Results:**
- ALA 1:2 LEV (3 - OVER)
- BIL 1:1 OVI (2 - exactly 2)
- ELC 0:2 RMA (2 - OVER)
- FCB 2:0 CEL (2 - OVER)
- GET 1:0 OSA (1 - UNDER)
- GIR 1:0 RBB (1 - UNDER)
- MAL 3:1 RAY (4 - OVER)
- SEV 1:1 RSO (2 - exactly 2)
- VCF 2:0 ESP (2 - OVER)
- VIL 0:1 ATM (1 - UNDER)
...
- FCB 3:0 RMA (3 - OVER)
- GET 0:1 RBB (1 - UNDER)
- GIR 1:1 ATM (2 - exactly 2)
- LEV 1:1 RAY (2 - exactly 2)
- MAL 1:0 ESP (1 - UNDER)
- SEV 0:0 VIL (0 - UNDER)
- VCF 1:0 OVI (1 - UNDER)

**OVER:** 3 | **UNDER:** 6 | **PUSH:** 1

### Slot 09:22 → 10:00
**Results:**
- ALA 0:1 RAY (1 - UNDER)
- BIL 1:1 VIL (2 - exactly 2)
- CEL 1:2 RMA (3 - OVER)
- ELC 1:2 RBB (3 - OVER)
- FCB 0:0 OSA (0 - UNDER)
- GET 1:0 ATM (1 - UNDER)
...
## April 1 Summary (Partial - First 22 slots)
